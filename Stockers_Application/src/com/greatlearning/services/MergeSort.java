...
public class MergeSort {
	public void mergeSort(double[] arr, int left, int right, String order) {
		if(left < right) {
			sort(arr,left,right,order);
		}
	}
	private void sort(double[] arr, int left, int right, String order) {
		if(left<right) {
	...
	private void merge(double[] arr, int left, int mid, int right, String order) {
